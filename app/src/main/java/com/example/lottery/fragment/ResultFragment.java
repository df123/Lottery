...
public class ResultFragment extends Fragment {
    ...
    private List<String> mLotteryResult;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLotteryResultView = RecyclerViewUtils.initRecyclerView(inflate, R.id.recycler_view_lottery_result, 9, getActivity());
        return inflate;
    }
    ...
    public void onResume() {
        super.onResume();
        if (mLotteryResult != null) {
            mLotteryResultView.setAdapter(new TableAdapter(mLotteryResult));
        }
    }
}