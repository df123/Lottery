...
public class DatePickerFragment extends DialogFragment {
    ...
    public static DatePickerFragment newInstance(DatePickerDialog.OnDateSetListener param1, String param2) {
        DatePickerFragment fragment = new DatePickerFragment(param1);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        datePickerDialog = new android.app.DatePickerDialog(getActivity(), onDateSetListener, year, month, day);
